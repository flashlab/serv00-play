...
if [[ "$BUTTON_URL" == "null" ]]; then
  button_url="https://github.com/flashlab/serv00-play/actions/workflows/deploy.yml"
else
  button_url=${BUTTON_URL:-"https://github.com/flashlab/serv00-play/actions/workflows/deploy.yml"}
fi
